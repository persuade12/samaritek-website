      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <div className="mb-20 md:mb-24">
            <h2 className="text-center text-2xl md:text-3xl font-bold text-foreground mb-10 md:mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
              {phases.map((phase, i) => (
                ...
                >
                  ...
                  <p className="text-muted-foreground leading-relaxed text-sm md:text-base">{phase.description}</p>
                </div>
              ))}
            </div>
          </div>
